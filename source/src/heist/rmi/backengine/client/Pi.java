package heist.rmi.backengine.client;

import java.math.BigDecimal;
import heist.rmi.backengine.interfaces.Task;

/**
 * This data type defines a method for the computation of PI with a variable
 * number of digits which is prepared to be moved to a remote host and be
 * executed there.
 */
